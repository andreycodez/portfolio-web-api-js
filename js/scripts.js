...
//         const randomUser = fetch(api.env.API_LINK)
//         randomUser
...
function generateUsersList(data) {
    ...
    for (const man of data) {
        ...
        image.setAttribute('src',man.avatar);
        ...
        dateOfBirth.innerHTML = 'DoB: ' + man.date_of_birth;
        const subsPlan = document.createElement('p');
        subsPlan.innerHTML = 'Plan: ' + man.subscription.plan;
